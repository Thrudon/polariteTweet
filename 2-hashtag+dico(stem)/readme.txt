...
- stemmingStopword.py permet de raciniser les stopwords qui seront enlevés pendant le traitement.
...
- associate_pred.py permet de lier les id des tweets aux résultats et sort un fichier res.txt prêt pour évaluation.
